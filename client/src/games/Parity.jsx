...
const Parity = () => {
  ...
  const updateCountdown = useCallback(() => {
    ...
    const distance = 180 - (countDownDate % 180); // Change 30 to 180 for 3 minutes
    ...
    <>
      <section id='fastParityNav' className='top-nav'>
          <div className='back' onClick={()=>{navigate(-1)}}>
             ...
             <span className='title'>Parity</span>
            ...
            <div className='game-record-body'>
              <div className='g-record'>
                  <div className='g-record-col'>
                    <div className='g-record-col-txt'>Parity Record(s)</div> <div className='g-record-col-more'><span>more {'>'}</span></div>
                  </div>
